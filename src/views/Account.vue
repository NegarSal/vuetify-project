<template>
 <div class="add mx-5 my-6" >
   <h1 class="pink--text mx-5 my-6" >log in:</h1>
     <v-card class="overflow-hidden mx-auto my-6" color="pink lighten-1" dark max-width="450"  >
       <v-toolbar flat color="pink lighten-1">
    ...
    <v-card-actions>
      <v-spacer></v-spacer>
      <v-btn :disabled="!isEditing" color="blue" @click="save">
        Save
      </v-btn>
    </v-card-actions>
